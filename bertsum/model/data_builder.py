...
def format_to_lines(args):
    train_files, valid_files, test_files = [], [], []
    for f in glob.glob(pjoin(args.raw_path+'/train_data/', '*.json')):
        train_files.append(f)
    for f in glob.glob(pjoin(args.raw_path+'/test_data/', '*.json')):
        test_files.append(f)
    for f in glob.glob(pjoin(args.raw_path+'/val_data/', '*.json')):
        valid_files.append(f)
